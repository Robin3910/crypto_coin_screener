...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            hma5, hma10, hma20, hma30, hma60, hma90, hma144, hma169, hmaclose,hmaopen = crawl_exchanges_dates('binance', usdt, '1d', 5, 10, 20, 30, 60, 90, 144, 169, 1440)
            ...
            if hmaclose > hma16905 > hma5 > hma169 > hmaopen and hmaclose > hma16905 > hma10 > hma169 > hmaopen and hmaclose > hma16905 > hma20 > hma169 > hmaopen and hmaclose > hma16905 > hma30 > hma169 > hmaopen and hmaclose > hma16905 > hma60 > hma169 > hmaopen and hmaclose > hma16905 > hma90 > hma169 > hmaopen and hmaclose > hma16905 > hma144 > hma169 > hmaopen:
                ...
                print(binan4Hk)
                print(f'币安1日多线接近测试且阳线贯穿一共{len(binan4Hk)}个')
                print("*" * 40)
    ...
    file_dir = os.path.join(current_path,'币安1日多线接近且阳线贯穿测试')
    ...
    filename = str(caiji_time) + '点ma1日多线接近且阳线贯穿测试所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点ma1日多线接近且阳线贯穿测试1日MA价格' + '.txt'
