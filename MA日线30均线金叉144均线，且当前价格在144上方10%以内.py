...
#@Author : 赵旭辉
#@File : MA日线30均线金叉144均线，且当前价格在144上方10%以内.py
#@Software ： PyCharm
...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            if hma14410 > hma30 > hma144 and hma14410 > hma > hma144:
                ...
                print(f'{usdt}符合')
                print(binan4Hk)
                print(f'币安MA日线30均线金叉144均线，且当前价格在144上方10%以内测试一共{len(binan4Hk)}个')
                print("*" * 40)
            else:
    ...
    file_dir = os.path.join(current_path,'币安MA日线30均线金叉144均线，且当前价格在144上方10%以内测试')
    ...
    filename = str(caiji_time) + '点MA日线30均线金叉144均线，且当前价格在144上方10%以内测试所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点MA日线30均线金叉144均线，且当前价格在144上方10%以内MA价格' + '.txt'
