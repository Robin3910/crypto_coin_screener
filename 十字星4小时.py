...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            hma5, hma10, hma20, hma30, hma60, hma90, hma144, hma169, hmaclose, hmaopen, hmahigh, hmalow = crawl_exchanges_dates('binance', usdt, '4h', 5, 6, 7, 8, 9, 10, 11, 12, 240)
    ...
    filename1 = str(caiji_time) + '点4小时十字星MA价格' + '.txt'
