...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            mma5, mma10, mma20, mma30, mma60, mma90, mma100, mma200, mmaclose,mmaopen = crawl_exchanges_dates('binance', usdt, '1h', 5, 10, 20, 30, 60, 90, 100, 200, 60)
            if mma10 == None:
                continue
            ...
            if mma20010 > mma60 > mma200:
                ...
                print(binan4Hk)
                print(f'币安MA1小时60上穿200上方百分之十以内一共{len(binan4Hk)}个')
                print("*" * 40)
    ...
    file_dir = os.path.join(current_path,'币安MA1小时60上穿200上方百分之十以内测试')
    ...
    filename = str(caiji_time) + '点MA1小时60上穿200上方百分之十以内测试所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点MA1小时60上穿200上方百分之十以内当前收盘价格' + '.txt'
