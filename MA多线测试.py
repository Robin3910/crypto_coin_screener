...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            hma14420 = float(hma144) + float(hma144) * 0.2
            hma16920 = float(hma169) + float(hma169) * 0.2




            if zma2020 > zma5 > zma10 > zma20 and rma3020 > rma5 > rma10 > rma20 > rma30 and hma14420 > hma5 > hma10 > hma20 > hma30 > hma60 > hma90 > hma144 > hma169 and hma16920 > hma5 > hma10 > hma20 > hma30 > hma60 > hma90 > hma144 > hma169:
                ...
                print(binan4Hk)
                print(f'币安多线测试一共{len(binan4Hk)}个')
                print("*" * 40)
    ...
    file_dir = os.path.join(current_path,'币安多线测试')
    ...
    filename = str(caiji_time) + '点ma多线测试所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点ma多线测试4小时MA价格' + '.txt'
