...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            mma5, mma10, mma20, mma30, mma60, mma90, mma610, mma985, mmaclose,mmaopen = crawl_exchanges_dates('binance', usdt, '5m', 5, 10, 20, 30, 60, 90, 610, 985, 5)
            ...
            if mma98510 > mmaclose > mma985 and mma610 > mma985:
                ...
                print(binan4Hk)
                print(f'币安MA5分钟610上穿985且当前价格在985上方百分之十以内一共{len(binan4Hk)}个')
                print("*" * 40)
    ...
    file_dir = os.path.join(current_path,'币安MA5分钟610上穿985且当前价格在985上方百分之十以内测试')
    ...
    filename = str(caiji_time) + '点MA5分钟610上穿985且当前价格在985上方百分之十以内测试所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点MA5分钟610上穿985且当前价格在985上方百分之十以内当前收盘价格' + '.txt'
