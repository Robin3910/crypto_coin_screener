...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            hma5, hma10, hma20, hma60, hma90, hma144, hma169, hma200, hmaclose,hmaopen = crawl_exchanges_dates('binance', usdt, '1d', 5, 10, 20, 60, 90, 144, 169, 200, 1440)
            if hma5 is None:
                continue
            ...
            if hma20005 > hma60 > hma200 and hma20005 > hma90 > hma200 and hma20005 > hma144 > hma200 and hma20005 > hma169 > hma200:
                ...
                print(binan4Hk)
                print(f'币安日线60，90，144，169，200多均线接近200以上百分之五一共{len(binan4Hk)}个')
                print("*" * 40)
    ...
    file_dir = os.path.join(current_path,'币安日线60，90，144，169，200多均线接近200以上百分之五')
    ...
    filename = str(caiji_time) + '点ma日线60，90，144，169，200多均线接近200以上百分之五所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点ma日线60，90，144，169，200多均线接近200以上百分之五MA价格' + '.txt'
