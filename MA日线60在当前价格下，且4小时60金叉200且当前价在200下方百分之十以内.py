...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            # if h4ma200 > h4maclose > h4ma20010 and h4ma60 > h4ma200 and rmaclose > rma60:
                ...
                print(binan4Hk)
                print(f'币安MA日线60在当前价格下，且4小时60金叉200且当前价在200下方百分之十以内一共{len(binan4Hk)}个')
                print("*" * 40)
    ...
    file_dir = os.path.join(current_path,'币安MA日线60在当前价格下，且4小时60金叉200且当前价在200下方百分之十以内测试')
    ...
    filename = str(caiji_time) + '点MA日线60在当前价格下，且4小时60金叉200且当前价在200下方百分之十以内测试所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点MA日线60在当前价格下，且4小时60金叉200且当前价在200下方百分之十以内当前收盘价格' + '.txt'
