...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            #
            rma5, rma10, rma20, rma30, rma35, rma36, rma37, rma60, rmaclose,rmaopen = crawl_exchanges_dates('binance', usdt, '1d', 5 ,10 , 20, 30, 35, 36, 37, 60, 1440)
            if rma5 is None:
                continue
            # rma3020 = float(rma30) + float(rma30) * 0.2

            h4ma5, h4ma10, h4ma20, h4ma30, h4ma60, h4ma90, h4ma100, h4ma200, h4maclose,h4maopen = crawl_exchanges_dates('binance', usdt, '4h', 5, 10, 20, 30, 60, 90, 100, 200, 240)
            # h4ma20010 = float(h4ma200) - float(h4ma200) * 0.1
            h4ma200100 = float(h4ma200) + float(h4ma200) * 0.1




            # if h4ma200 > h4maclose > h4ma20010 and h4ma60 > h4ma200 and rmaclose > rma60:
            if h4ma200100 > h4maclose > h4ma200 and h4ma60 > h4ma200 and rmaclose > rma60:

                binan4Hk.append(usdt)
                binan4Hv.append(h4maclose)
                print(f'{usdt}符合')
            else:
                ...
                print(binan4Hk)
                print(f'币安MA日线60在当前价格下，且4小时60金叉200且当前价在200上方百分之十以内一共{len(binan4Hk)}个')
                print("*" * 40)
    ...
    file_dir = os.path.join(current_path,'币安MA日线60在当前价格下，且4小时60金叉200且当前价在200上方百分之十以内测试')
    ...
    filename = str(caiji_time) + '点MA日线60在当前价格下，且4小时60金叉200且当前价在200上方百分之十以内测试所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点MA日线60在当前价格下，且4小时60金叉200且当前价在200上方百分之十以内当前收盘价格' + '.txt'
