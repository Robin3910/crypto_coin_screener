...
if __name__=='__main__':
    ...
    for usdt in usdts:
        try:
            ...
            hma5, hma10, hma20, hma30, hma60, hma90, hma144, hma169, hma = crawl_exchanges_dates('binance', usdt, '1d', 5, 10, 20, 30, 60, 90, 144, 169, 1440)
            if hma5 is None:
                continue
            hma9010 = float(hma90) + float(hma90) * 0.1
            hma9001 = float(hma90) - float(hma90) * 0.1



            if hma9010 > hma5 > hma9001 and hma9010 > hma10 > hma9001 and hma9010 > hma20 > hma9001 and hma9010 > hma30 > hma9001 and hma9010 > hma60 > hma9001 and hma9010 > hma90 > hma9001 and hma9010 > hma144 > hma9001 and hma9010 > hma169 > hma9001:
                ...
                print(binan4Hk)
                print(f'币安日线5,10,20,30,60.90.144.169均线在90均线上下各百分之十以内测试一共{len(binan4Hk)}个')
                print("*" * 40)
    ...
    file_dir = os.path.join(current_path,'币安日线5,10,20,30,60.90.144.169均线在90均线上下各百分之十以内测试')
    ...
    filename = str(caiji_time) + '点ma日线5,10,20,30,60.90.144.169均线在90均线上下各百分之十以内测试所有币' + '.txt'
    with open(f'{file_dir}//{filename}', 'w') as f:
        f.write(str(binan4Hk))

    filename1 = str(caiji_time) + '点ma日线5,10,20,30,60.90.144.169均线在90均线上下各百分之十以内MA价格' + '.txt'
